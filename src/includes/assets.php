...
function enqueue_assets() {
    ...
    if (\get_query_var('iande_controller') === 'itinerary') {
        \wp_enqueue_script('iande-tainacan', IANDE_PLUGIN_DISTURL . 'tainacan-view-modes.js', ['underscore', 'tainacan-blocks-common-theme-scripts', 'wp-i18n'], IANDE_PLUGIN_VERSION, true);
    }
}
