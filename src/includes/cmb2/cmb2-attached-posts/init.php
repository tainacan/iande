...
class WDS_CMB2_Attached_Posts_Field {
	...
	public function render( $field, $escaped_value, $object_id, $object_type, $field_type ) {
		...
		echo '<h4 class="attached-posts-section">' . sprintf( __( '%s disponíveis', 'cmb' ), $post_type_labels ) . '</h4>';
		...
		echo '<h4 class="attached-posts-section">' . sprintf( __( '%s selecionadas', 'cmb' ), $post_type_labels ) . '</h4>';
