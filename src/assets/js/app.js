...
import { faAngleDoubleLeft, faAngleDoubleRight, faAngleLeft, faAngleRight, faArrowLeft, faBars, faBus, faCaretDown, faCheck, faCircleCheck, faCircleInfo, faCircleMinus, faCirclePlus, faCircleQuestion, faEye, faGear, faGripVertical, faLandmark, faListUl, faPen, faPrint, faShareNodes, faSpinner, faStar, faUserLarge, faUsers, faXmark } from '@fortawesome/free-solid-svg-icons'
...
library.add(faAngleDoubleLeft, faAngleDoubleRight, faAngleLeft, faAngleRight, faArrowLeft, faBars, faBus, faCaretDown, faCheck, faCircleCheck, faCircleInfo, faCircleMinus, faCirclePlus, faCircleQuestion, faEye, faGear, faGripVertical, faLandmark, faListUl, faPen, faPrint, faShareNodes, faSpinner, faStar, faUserLarge, faUsers, faXmark)
