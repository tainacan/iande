...
import { faAngleDoubleLeft, faAngleDoubleRight, faAngleLeft, faAngleRight, faArrowLeft, faBars, faCaretDown, faCheck, faCircleCheck, faCircleInfo, faCircleMinus, faCirclePlus, faCircleQuestion, faEye, faGear, faGripVertical, faLandmark, faListUl, faLocationDot, faMinus, faPen, faPrint, faShareNodes, faSpinner, faStar, faUserGroup, faUserLarge, faXmark } from '@fortawesome/free-solid-svg-icons'
...
library.add(faAngleDoubleLeft, faAngleDoubleRight, faAngleLeft, faAngleRight, faArrowLeft, faBars, faCaretDown, faCheck, faCircleCheck, faCircleInfo, faCircleMinus, faCirclePlus, faCircleQuestion, faEye, faGear, faGripVertical, faLandmark, faListUl, faLocationDot, faMinus, faPen, faPrint, faShareNodes, faSpinner, faStar, faUserGroup, faUserLarge, faXmark)
