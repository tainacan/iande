...
<script>
    export default {
        ...
        computed: {
            confirmedGroups () {
                return this.groups.filter(group => group.appointment.post_status === 'publish').length
            },
            pendingGroups () {
                return this.groups.filter(group => group.appointment.post_status === 'pending').length
            },
        },
    }
</script>
