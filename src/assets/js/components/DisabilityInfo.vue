<template>
    <div class="iande-stack stack-lg">
        <div>
            <label :for="`${id}_type`" class="iande-label">Qual tipo de necessidade especial?</label>
        ...
        <div v-if="isOther(type)">
            <label :for="`${id}_other`" class="iande-label">Especifique o tipo de necessidade especial</label>
